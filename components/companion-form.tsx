...
export const CompanionForm = ({ initialData, categories }: CompanionFormProps) => {
  ...
  const onSubmit = async (values: z.infer<typeof formSchema>) => {
    try {
      if (initialData) {
        //Update companion functionnality
        await axios.patch(`/api/companion/${initialData.id}`, values)
      } else {
        // Create companion functionnality
              ...
              render={({ field }) => (
                <FormItem className='col-span-2 md:col-span-1'>
                  ...
                  <FormControl>
                    <Input
                      disabled={isLoading}
                      placeholder='CEO & Fround of Tesla, SpaceX'
                      {...field}
                    />
                  </FormControl>
                  <FormDescription>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>Select a category for you AI</FormDescription>
                  <FormMessage />
                </FormItem>
              )}
            />
